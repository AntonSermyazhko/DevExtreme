...
var KeyboardNavigationController = core.ViewController.inherit({
    ...
    */
    ...
    _fireFocusedCellChanging: function($event, $cellElement, isHighlighted) {
        ...
        this._canceledFocusCellPosition = undefined;
        ...
        if(args.cancel) {
            this._canceledFocusCellPosition = { rowIndex: rowIndex, columnIndex: columnIndex };
        }
        ...
        controllers: {
            editing: {
                editCell: function(rowIndex, columnIndex) {
                    ...
                    if(keyboardNavigationController._canceledFocusCellPosition) {
                        let canceledCellRowIndex = keyboardNavigationController._canceledFocusCellPosition.rowIndex,
                            canceledCellColumnIndex = keyboardNavigationController._canceledFocusCellPosition.columnIndex;

                        if(canceledCellRowIndex === rowIndex && canceledCellColumnIndex === columnIndex) {
                            keyboardNavigationController._canceledFocusCellPosition = undefined;
                            return false;
                        }
                    }
